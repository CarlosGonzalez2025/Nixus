...
function PermitDetailPage() {
    ...
    const handleExportToPDF = async ()=>{
        try {
            ...
            // Crear nuevo documento PDF con configuración optimizada
            ...
            pdf.setProperties({
                title: `Permiso de Trabajo - ${permit?.numeroPermiso || 'SIN NÚMERO'}`,
                author: 'ITALCOL - Sistema de Gestión de Permisos de Trabajo',
            ...
            const addProfessionalHeader = async (pageNumber = 1)=>{
                ...
                pdf.setFillColor(25, 55, 150); // Azul más oscuro
                ...
                try {
                    ...
                    pdf.setFontSize(8);
                    pdf.text('Industrial y Tecnológica de Colombia', margin + 30, 18);
                } catch (error) {
                    ...
                    pdf.setFont('helvetica', 'normal');
                    pdf.setFontSize(8);
                    pdf.text('Industrial y Tecnológica de Colombia', margin, 21);
                }
                ...
                pdf.setFont('helvetica', 'normal');
                pdf.setFontSize(9);
                pdf.text('Sistema de Gestión de Permisos de Trabajo', pageWidth / 2, 19, {
                    align: 'center'
                });
                // Información del permiso a la derecha
                pdf.setFont('helvetica', 'bold');
                pdf.setFontSize(11);
            ...
            // ===== FUNCIÓN PARA GRID DE INFORMACIÓN =====
            ...
            toast({
                title: 'Generando PDF...',
                description: 'Agregando información general... (25%)'
            });
            // ===== INFORMACIÓN GENERAL =====
            ...
            const generalFields = [
                ...
                },
                {
                    ...
                    value: permit?.fechaInicio ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(permit.fechaInicio), 'dd/MM/yyyy') : ''
                },
                {
                ...
                },
                {
                    ...
                    value: permit?.fechaFin ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(permit.fechaFin), 'dd/MM/yyyy') : ''
                },
                {
            ...
            // Descripción del trabajo (campo completo)
            if (permit?.descripcionTrabajo) {
                addField('Descripción del Trabajo:', permit.descripcionTrabajo, true);
            }
            toast({
                title: 'Generando PDF...',
                description: 'Agregando verificación de peligros... (40%)'
            });
            // ===== VERIFICACIÓN DE PELIGROS =====
            addSectionTitle('VERIFICACIÓN DE PELIGROS ASOCIADOS A LA ACTIVIDAD');
            const peligros = [
                {
                    key: 'trabajoAlturas',
            ...
            toast({
                title: 'Generando PDF...',
                description: 'Procesando anexos específicos... (60%)'
            });
            // ===== ANEXOS ESPECÍFICOS =====
            ...
            if (permit?.anexoAltura) {
                ...
                if (permit.anexoAltura.checklist) {
                    const checklistItems = [
                        {
                            key: 'equiposRevision',
                            label: 'Se revisaron los equipos de protección personal'
                        },
                        {
                            key: 'puntosAnclaje',
                        ...
                        },
                        {
                            ...
                            label: 'Las condiciones climáticas son adecuadas'
                        },
                        {
                            key: 'areaDelimitada',
                            label: 'El área de trabajo está delimitada y señalizada'
                        },
                        {
                            key: 'personalCapacitado',
                            label: 'Todo el personal está capacitado y certificado'
                        }
                    ];
            ...
            if (permit?.anexoConfinado) {
                ...
                if (permit.anexoConfinado.medicionesAtmosfericas) {
                    ...
                    pdf.setFont('helvetica', 'bold');
                    pdf.setFontSize(10);
                    pdf.text('Mediciones Atmosféricas:', margin, currentY);
                    currentY += 8;
                    const mediciones = [
                        {
                            label: 'Oxígeno (%):',
                        ...
                        {
                            label: 'Sulfuro de Hidrógeno (ppm):',
            ...
            if (permit?.anexoEnergias) {
                addSectionTitle('ANEXO - CONTROL DE ENERGÍAS PELIGROSAS');
                const energiaFields = [
                    {
            ...
            roles.forEach((role)=>{
                ...
                if (approval?.signed) {
                    ...
                    if (approval.timestamp) {
                        ...
                        pdf.text(`Fecha: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(fechaFirma, 'dd/MM/yyyy HH:mm')}`, margin + 5, currentY + 17);
                    }
            ...
            if (permit?.closure) {
                addSectionTitle('EMISIÓN, REVALIDACIÓN Y CIERRE');
                const closureFields = [
                    {
                ...
                const closureChecks = [
                    ...
                    },
                    {
                        ...
                        label: 'Se evidencia partículas o material encendido que pueda generar riesgo'
                    },
                    {
                        key: 'continuaLabor',
            ...
            for(let i = 1; i <= totalPages; i++){
                ...
                pdf.text('Código: DN-FR-SST-016', margin, pageHeight - 8);
                pdf.text('Versión: 05', margin, pageHeight - 4);
                // Fecha de generación
                const now = new Date();
                pdf.text(`Generado: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(now, 'dd/MM/yyyy HH:mm')}`, pageWidth / 2, pageHeight - 8, {
                    align: 'center'
                });
                // Número de página
            ...
            const fechaActual = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd');
            ...
            toast({
                ...
                description: 'Ocurrió un error durante la generación. Por favor, intente nuevamente.',
                variant: 'destructive'
            });
        }
    };
    ...
    const canChangeStatus = (newStatus)=>{
        ...
        // Lógica específica por rol y estado
        switch(newStatus){
            case 'aprobado':
    ...
    const canSign = (role, signatureType)=>{
        ...
        // Lógica específica por tipo de firma
    ...
    const handleChangeStatus = async (newStatus, reason)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$932d64__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updatePermitStatus"])(permit.id, newStatus, user.uid, reason);
            toast({
    ...
    const handleSaveSignature = async (signatureBase64)=>{
        ...
        setIsSigning(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$5ff772__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSignatureAndNotify"])(permit.id, signingRole.role, signingRole.type, signatureBase64, user.uid, user.displayName || user.email || 'Usuario');
            toast({
    ...
    const handleClosureFieldChange = async (field, value)=>{
        ...
        try {
            ...
            toast({
                title: 'Error',
                description: 'No se pudo actualizar la información de cierre.',
                variant: 'destructive'
            });
        }
    };
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Section, {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                            label: "Fecha de Inicio",
                                            value: permit.fechaInicio ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(permit.fechaInicio), 'dd/MM/yyyy') : undefined
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/permits/[id]/page.tsx",
                                            lineNumber: 1057,
                                            columnNumber: 25
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                            label: "Fecha de Finalización",
                                            value: permit.fechaFin ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(permit.fechaFin), 'dd/MM/yyyy') : undefined
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/permits/[id]/page.tsx",
                                            lineNumber: 1059,
                                            columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Section, {
                                title: "Verificación de los Peligros Asociados a la Actividad",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 md:grid-cols-2 gap-4",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            permit.anexoAltura && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Section, {
                            ...
                            permit.anexoConfinado && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Section, {
                                ...
                                children: [
                                    ...
                                    permit.anexoConfinado.medicionesAtmosfericas && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-4",
                                        children: [
                            ...
                            permit.anexoEnergias && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Section, {
                                title: "Anexo - Control de Energías Peligrosas",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "grid grid-cols-1 md:grid-cols-2 gap-4",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Field, {
                                                                    ...
                                                                    value: approval?.timestamp ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(approval.timestamp), 'dd/MM/yyyy HH:mm') : 'Pendiente'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/app/(app)/permits/[id]/page.tsx",
                                                                    lineNumber: 1144,
                                                                    columnNumber: 45
...
_s(PermitDetailPage, "7FPaI1bki4u84x7iLjq5CBI12YM=", false, function() {
    return [
...
//# sourceMappingURL=src_d4627834._.js.map