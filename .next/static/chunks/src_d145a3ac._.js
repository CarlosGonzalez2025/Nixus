            ...
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                "Dashboard.useEffect.unsubscribe": (snapshot)=>{
                    const allRecentPermits = snapshot.docs.map({
                        "Dashboard.useEffect.unsubscribe.allRecentPermits": (doc)=>{
                            const data = doc.data();
                            return {
                                id: doc.id,
                                ...data,
                    ...
                    }["Dashboard.useEffect.unsubscribe.allRecentPermits"]);
                    ...
                    const statsUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(statsQuery, {
                        "Dashboard.useEffect.unsubscribe.statsUnsubscribe": (statsSnapshot)=>{
                            const allPermits = statsSnapshot.docs.map({
                                "Dashboard.useEffect.unsubscribe.statsUnsubscribe.allPermits": (d)=>d.data()
                            }["Dashboard.useEffect.unsubscribe.statsUnsubscribe.allPermits"]);
                            setStats({
                                total: allPermits.length,
                                pendiente: allPermits.filter({
                                    "Dashboard.useEffect.unsubscribe.statsUnsubscribe": (p)=>p.status === 'pendiente_revision'
                                }["Dashboard.useEffect.unsubscribe.statsUnsubscribe"]).length,
                                aprobado: allPermits.filter({
                                    "Dashboard.useEffect.unsubscribe.statsUnsubscribe": (p)=>p.status === 'aprobado'
                                }["Dashboard.useEffect.unsubscribe.statsUnsubscribe"]).length,
                                enEjecucion: allPermits.filter({
                                    "Dashboard.useEffect.unsubscribe.statsUnsubscribe": (p)=>p.status === 'en_ejecucion'
                                }["Dashboard.useEffect.unsubscribe.statsUnsubscribe"]).length
                            });
                        }
                    }["Dashboard.useEffect.unsubscribe.statsUnsubscribe"], {
                        "Dashboard.useEffect.unsubscribe.statsUnsubscribe": (error)=>{
...
_s(Dashboard, "v906YkAnTywsuoZJx8lAm8yGsvM=", false, function() {
    return [
...
//# sourceMappingURL=src_d145a3ac._.js.map