...
function AuthProvider(param) {
    ...
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAuth"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
    ...
    const login = async (email, password)=>{
        try {
            return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithEmailAndPassword"])(auth, email, password);
        } catch (error) {
            if (error.code === 'auth/user-not-found' && demoUsers[email.toLowerCase()]) {
                const newUserCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createUserWithEmailAndPassword"])(auth, email, password);
                ...
                if (firebaseUser) {
                    ...
                    const userProfile = {
                        ...
                        displayName: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.name) || firebaseUser.email,
                        photoURL: firebaseUser.photoURL || '',
                        role: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.role) || 'ejecutante',
                        empresa: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.empresa) || 'N/A',
                        ciudad: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.ciudad) || 'N/A',
                        planta: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.planta) || 'N/A',
                        area: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.area) || 'N/A',
                        telefono: (demoUser === null || demoUser === void 0 ? void 0 : demoUser.telefono) || ''
                    };
...
//# sourceMappingURL=src_11cbadb7._.js.map