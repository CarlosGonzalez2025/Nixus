...
function Dashboard() {
    ...
    const [permits, setPermits] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            if (user.role === 'lider_sst') {
                    ...
                    "Dashboard.useEffect.fetchData": async ()=>{
                        try {
                            ...
                            snapshot1.docs.forEach({
                                "Dashboard.useEffect.fetchData": (doc)=>{
                            ...
                            const combinedPermits = Array.from(permitsMap.values()).sort({
                                "Dashboard.useEffect.fetchData.combinedPermits": (a, b)=>{
                            ...
                            }["Dashboard.useEffect.fetchData.combinedPermits"]);
                            ...
                            setStats({
                                ...
                                pendiente: combinedPermits.filter({
                                    "Dashboard.useEffect.fetchData": (p)=>p.status === 'pendiente_revision'
                                }["Dashboard.useEffect.fetchData"]).length,
                                aprobado: combinedPermits.filter({
                                    "Dashboard.useEffect.fetchData": (p)=>p.status === 'aprobado'
                                }["Dashboard.useEffect.fetchData"]).length,
                                enEjecucion: combinedPermits.filter({
                                    "Dashboard.useEffect.fetchData": (p)=>p.status === 'en_ejecucion'
                                }["Dashboard.useEffect.fetchData"]).length
                            });
                            setLoading(false);
                        } catch (error) {
                ...
                const unsub1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q1, fetchData, {
                    "Dashboard.useEffect.unsub1": (e)=>{
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: q1.toString(),
                            operation: 'list'
                        });
                ...
                }["Dashboard.useEffect.unsub1"]);
                const unsub2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q2, fetchData, {
                    "Dashboard.useEffect.unsub2": (e)=>{
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: q2.toString(),
                            operation: 'list'
                        });
                ...
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(q, {
                    "Dashboard.useEffect.unsubscribe": (snapshot)=>{
                        let permitsData = snapshot.docs.map({
                            "Dashboard.useEffect.unsubscribe.permitsData": (doc)=>({
                                    id: doc.id,
                                    ...doc.data(),
                                    createdAt: parseFirestoreDate(doc.data().createdAt)
                                })
                        }["Dashboard.useEffect.unsubscribe.permitsData"]);
                        permitsData = permitsData.sort({
                            "Dashboard.useEffect.unsubscribe": (a, b)=>{
                                var _b_createdAt, _a_createdAt;
                                return (((_b_createdAt = b.createdAt) === null || _b_createdAt === void 0 ? void 0 : _b_createdAt.getTime()) || 0) - (((_a_createdAt = a.createdAt) === null || _a_createdAt === void 0 ? void 0 : _a_createdAt.getTime()) || 0);
                            }
                        ...
                        setStats({
                            ...
                            pendiente: permitsData.filter({
                                "Dashboard.useEffect.unsubscribe": (p)=>p.status === 'pendiente_revision'
                            }["Dashboard.useEffect.unsubscribe"]).length,
                            aprobado: permitsData.filter({
                                "Dashboard.useEffect.unsubscribe": (p)=>p.status === 'aprobado'
                            }["Dashboard.useEffect.unsubscribe"]).length,
                            enEjecucion: permitsData.filter({
                                "Dashboard.useEffect.unsubscribe": (p)=>p.status === 'en_ejecucion'
                            }["Dashboard.useEffect.unsubscribe"]).length
                        });
                        setLoading(false);
                    }
                }["Dashboard.useEffect.unsubscribe"], {
                    "Dashboard.useEffect.unsubscribe": (error)=>{
                        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$errors$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
                            path: permitsCollection.path,
                            operation: 'list'
                        });
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    children: [
                                                                        "Creado por: ",
                                                                        ((_permit_user = permit.user) === null || _permit_user === void 0 ? void 0 : _permit_user.displayName) || 'N/A'
                                                                    ]
                                                                }, void 0, true, {
                                                                    fileName: "[project]/src/app/(app)/dashboard/page.tsx",
                                                                    lineNumber: 380,
...
_s(Dashboard, "dnrdLm3cZmHXYAqeaY1F1RkKtoo=", false, function() {
    return [
...
//# sourceMappingURL=_8969f77d._.js.map