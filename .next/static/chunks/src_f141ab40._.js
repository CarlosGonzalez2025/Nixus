    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            ...
            try {
                ...
                const allPermitsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["query"])(permitsCollection, ...queryConstraints);
                const statsUnsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(allPermitsQuery, {
                    "Dashboard.useEffect.statsUnsubscribe": (statsSnapshot)=>{
                        ...
                        const allPermits = statsSnapshot.docs.map({
                            "Dashboard.useEffect.statsUnsubscribe.allPermits": (d)=>d.data()
                        }["Dashboard.useEffect.statsUnsubscribe.allPermits"]);
                        setStats({
                            total: allPermits.length,
                            pendiente: allPermits.filter({
                                "Dashboard.useEffect.statsUnsubscribe": (p)=>p.status === 'pendiente_revision'
                            }["Dashboard.useEffect.statsUnsubscribe"]).length,
                            aprobado: allPermits.filter({
                                "Dashboard.useEffect.statsUnsubscribe": (p)=>p.status === 'aprobado'
                            }["Dashboard.useEffect.statsUnsubscribe"]).length,
                            enEjecucion: allPermits.filter({
...
//# sourceMappingURL=src_f141ab40._.js.map