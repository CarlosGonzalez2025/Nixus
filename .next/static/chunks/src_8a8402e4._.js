...
function useIdleTimer({ timeout = 30 * 60 * 1000, onIdle, onActive, events = [
    ...
    const reset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useIdleTimer.useCallback[reset]": ()=>{
            ...
            }["useIdleTimer.useCallback[reset]"], timeout);
        }
    }["useIdleTimer.useCallback[reset]"], [
        disabled,
        timeout,
...
_s(useIdleTimer, "5kgdEHQLX7KXbioCHrOuf7vAZYY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
function IdleTimerProvider({ children, timeout = 30, warningTime = 5 // 5 minutos de advertencia
    ...
    const [warningShown, setWarningShown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const timeoutMs = timeout * 60 * 1000; // convertir a milisegundos
    const warningTimeMs = warningTime * 60 * 1000;
    const { reset } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$idle$2d$timer$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIdleTimer"])({
        timeout: timeoutMs,
        disabled: !user,
        onIdle: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IdleTimerProvider.useEffect": ()=>{
            ...
            const startWarningTimer = {
                "IdleTimerProvider.useEffect.startWarningTimer": ()=>{
                        ...
                        "IdleTimerProvider.useEffect.startWarningTimer": ()=>{
                            if (!warningShown) {
                                ...
                                const startCountdown = {
                                    "IdleTimerProvider.useEffect.startWarningTimer.startCountdown": ()=>{
                                        countdownTimer = setInterval({
                                            "IdleTimerProvider.useEffect.startWarningTimer.startCountdown": ()=>{
                                                setCountdown({
                                                    "IdleTimerProvider.useEffect.startWarningTimer.startCountdown": (prev)=>{
                                                        if (prev <= 1) {
                                        ...
                                        }["IdleTimerProvider.useEffect.startWarningTimer.startCountdown"], 1000);
                                    }
                                }["IdleTimerProvider.useEffect.startWarningTimer.startCountdown"];
                                startCountdown();
                            }
                        }
                    }["IdleTimerProvider.useEffect.startWarningTimer"], timeoutMs - warningTimeMs);
                }
            }["IdleTimerProvider.useEffect.startWarningTimer"];
            startWarningTimer();
            return ({
...
_s(IdleTimerProvider, "17FTdZ0UgbMkqDBTL8QO1BrjuCs=", false, function() {
    return [
