...
"[project]/src/app/(app)/permits/data:5aa214 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(app)/permits/data:e12e60 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(app)/permits/data:40bc04 [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(app)/permits/data:c2b83a [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$5aa214__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:5aa214 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$e12e60__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:e12e60 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$40bc04__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:40bc04 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$c2b83a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:c2b83a [app-client] (ecmascript) <text/javascript>");
...
function PermitDetailPage() {
    ...
    const handleExportToPDF = async ()=>{
        ...
        try {
            const doc = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2f$dist$2f$jspdf$2e$es$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]('p', 'mm', 'letter'); // Carta: 215.9 x 279.4 mm
            ...
            const italcolOrange = [
                ...
                123,
                0
            ]; // Aproximado naranja corporativo
            const headerBg = [
                255,
                255,
                255
            ...
            const sectionBg = [
                ...
                123,
                0
            ]; // Naranja para títulos de sección
            // ----------------------------------------------------------------------
            // 1. HELPERS
            // ----------------------------------------------------------------------
            ...
            const drawHeader = (title, code = "DN-FR-SST-016", version = "04")=>{
                ...
                doc.setFontSize(14);
                doc.setFont('helvetica', 'bold');
                doc.text(title.toUpperCase(), pageWidth / 2, 22, {
                    align: 'center'
                });
                // Caja ISO (Derecha) 
                doc.setFontSize(8);
                doc.setFont('helvetica', 'normal');
                doc.text(`Código: ${code}`, pageWidth - margin - 5, 18, {
                    align: 'right'
                });
                doc.text(`Versión: ${version}`, pageWidth - margin - 5, 23, {
                    align: 'right'
                });
            ...
            const drawDailyValidationTable = (validationData, anexoId)=>{
                checkPageBreak(40);
                doc.setFontSize(9);
                doc.setFont('helvetica', 'bold');
                doc.setFillColor(230, 230, 230);
                doc.rect(margin, yPos, pageWidth - 2 * margin, 6, 'F');
                doc.text("VALIDACIÓN DIARIA (CONDICIONES DE SEGURIDAD Y CIERRE)", pageWidth / 2, yPos + 4, {
                    align: 'center'
                });
                yPos += 8;
                const days = [
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2d$autotable$2f$dist$2f$jspdf$2e$plugin$2e$autotable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(doc, {
                ...
                body: [
                    [
                        ...
                        permit.createdAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(permit.createdAt, 'dd/MM/yyyy') : '',
                        {
                            content: 'Planta:',
                            styles: {
                                fontStyle: 'bold',
            ...
            for(let i = 0; i < activeRisks.length; i += 3){
                riskRows.push([
                    activeRisks[i] ? `[X] ${activeRisks[i].label}` : '',
                    activeRisks[i + 1] ? `[X] ${activeRisks[i + 1].label}` : '',
            ...
            const sigBoxH = 25;
            let currentX = margin;
            const drawSigBox = (roleTitle, approval)=>{
                doc.setDrawColor(0);
                ...
                if (approval?.status === 'aprobado') {
                    ...
                    doc.text(approval.signedAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(parseFirestoreDate(approval.signedAt), 'dd/MM/yy') : '', currentX + 2, yPos + 23);
                }
                currentX += sigBoxW;
            };
            ...
            if (permit.selectedWorkTypes?.confinado && permit.anexoConfinado) {
                ...
                const periodData = periodicas.map((p)=>[
                        p.hora,
                        p.lel,
                        p.o2,
                        p.h2s,
            ...
            if (permit.selectedWorkTypes?.energia && permit.anexoEnergias) {
                ...
                const energias = Object.entries(permit.anexoEnergias.energiasPeligrosas || {}).filter(([, v])=>v).map(([k])=>[
            ...
            if (permit.selectedWorkTypes?.izaje && permit.anexoIzaje) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2d$autotable$2f$dist$2f$jspdf$2e$plugin$2e$autotable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(doc, {
                    ...
                    body: [
                        [
                            'Peso Carga:',
                            Object.keys(permit.anexoIzaje.informacionGeneral?.pesoCarga || {}).filter((k)=>(permit.anexoIzaje?.informacionGeneral?.pesoCarga)[k]).join(' / ')
                        ],
                        [
                            'Equipo:',
                            Object.keys(permit.anexoIzaje.informacionGeneral?.equipoUtilizar || {}).filter((k)=>(permit.anexoIzaje?.informacionGeneral?.equipoUtilizar)[k]).join(' / ')
                        ]
                    ],
                    theme: 'grid',
                    styles: {
            ...
            if (permit.selectedWorkTypes?.excavacion && permit.anexoExcavaciones) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jspdf$2d$autotable$2f$dist$2f$jspdf$2e$plugin$2e$autotable$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(doc, {
                    ...
                    body: [
                        [
                            'Profundidad:',
                            permit.anexoExcavaciones.informacionGeneral?.profundidad || ''
                        ],
                        [
                            'Ancho:',
                            permit.anexoExcavaciones.informacionGeneral?.ancho || ''
                        ],
                        [
                            'Largo:',
                            permit.anexoExcavaciones.informacionGeneral?.largo || ''
                        ]
                    ],
                    theme: 'grid',
                    styles: {
    ...
    const handleSaveSignature = async (signatureDataUrl)=>{
        ...
        try {
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$e12e60__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSignatureAndNotify"])(permit.id, signingRole.role, signingRole.type, signatureDataUrl, userToSign);
            if (result.success) {
                toast({
    ...
    const handleChangeStatus = async (newStatus, reason)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$5aa214__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updatePermitStatus"])(permit.id, newStatus, reason, permit.closure);
            if (result.success) {
                toast({
    ...
    const handleSaveDailyValidationSignature = async (signature)=>{
        ...
        setIsSigning(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$40bc04__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addDailyValidationSignature"])(permit.id, dailyValidationTarget.anexo, dailyValidationTarget.type, dailyValidationTarget.index, {
    ...
    const handleSaveWorkerSignature = async (signature)=>{
        ...
        setIsSigning(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$c2b83a__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addWorkerSignature"])(permit.id, workerSignatureTarget.index, workerSignatureTarget.type, signature);
            if (result.success) {
                toast({
...
_s(PermitDetailPage, "tZxqrqJs3ZVx9pOdcx2uaxc5uL4=", false, function() {
    return [
...
//# sourceMappingURL=src_e1ac106e._.js.map