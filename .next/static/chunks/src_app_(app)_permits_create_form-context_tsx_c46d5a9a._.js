...
const initializer = function() {
    let initialValue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : initialState;
...
const validateEmergenciasStep = (eppEmergencias)=>{
    ...
    emergenciasRequired.forEach((field)=>{
        var _eppEmergencias_emergencias;
        const value = (_eppEmergencias_emergencias = eppEmergencias.emergencias) === null || _eppEmergencias_emergencias === void 0 ? void 0 : _eppEmergencias_emergencias[field];
        if (value === 'no') {
            errors.push('El campo "'.concat(field, '" debe estar en "SI"'));
            hasNoResponses = true;
        } else if (!value || value === '') {
            errors.push('El campo "'.concat(field, '" no ha sido seleccionado'));
        }
    });
    return {
...
function PermitFormProvider(param) {
    let { children } = param;
    _s();
...
//# sourceMappingURL=src_app_%28app%29_permits_create_form-context_tsx_c46d5a9a._.js.map