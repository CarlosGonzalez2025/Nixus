...
"[project]/src/app/(app)/permits/data:5614bf [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(app)/permits/data:02b9a1 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$5614bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:5614bf [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$02b9a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/data:02b9a1 [app-ssr] (ecmascript) <text/javascript>");
...
function PermitDetailPage() {
    ...
    const handleSaveSignature = async (signatureDataUrl)=>{
        ...
        setIsSigning(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$02b9a1__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addSignatureAndNotify"])(permit.id, signingRole.role, signingRole.type, signatureDataUrl, {
                uid: currentUser.uid,
    ...
    const handleChangeStatus = async (newStatus, reason)=>{
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$data$3a$5614bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updatePermitStatus"])(permit.id, newStatus, reason, permit.closure);
            if (result.success) {
                toast({
    ...
    const canSign = (role)=>{
        ...
        switch(role){
            case 'solicitante':
                ...
                return {
                    can: canSignSolicitante,
                    reason: canSignSolicitante ? undefined : 'Ya has firmado.'
                };
            case 'autorizante':
                ...
                return {
                    can: canSignAutorizante,
                    reason: canSignAutorizante ? undefined : 'Ya has firmado.'
                };
            case 'mantenimiento':
                ...
                return {
                    can: canSignMantenimiento,
                    reason: canSignMantenimiento ? undefined : 'Ya has firmado.'
                };
            case 'lider_sst':
                ...
                return {
                    can: canSignLiderSST,
                    reason: canSignLiderSST ? undefined : 'Ya has firmado.'
                };
            default:
                return {
                    can: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb71c108._.js.map