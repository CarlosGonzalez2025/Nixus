...
/* __next_internal_action_entry_do_not_use__ [{"401402f01c0118016efe5c5d736d335e2f6d150079":"createPermit","407282eb75929b38cb56be7f0cd547a72b6c80de19":"savePermitDraft","7873b9c7850e737568a6f6f7a4e17cda15a8f18e15":"updatePermitStatus","78ef86f0b5ad2d150f478f7151b2ac622c1a91d8a4":"addWorkerSignature","7e15bdb6ac388e78a59299d5091891127d63de7bc6":"addSignatureAndNotify","7edc6233c637b331b2fa6dba912da67e147424b389":"addDailyValidationSignature"},"",""] */ __turbopack_context__.s([
...
Ver detalles: ${permitUrl}`;
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendWhatsAppNotification"])(whatsappMsg);
        }
...
async function validateSignaturePermission(permitId, signatureRole, currentUser) {
    ...
    if (![
        ...
        return {
            allowed: false,
            reason: `No se puede firmar un permiso en estado '${permit.status}'.`
        };
    }
    switch(signatureRole){
        case 'coordinador_alturas':
            ...
            if (!permit.trabajoAlturas && !permit.selectedWorkTypes?.alturas) {
                return {
                    allowed: false,
                    reason: 'Esta firma solo aplica para trabajos en alturas.'
                };
            }
        ...
        case 'solicitante':
            ...
            if ((permit.trabajoAlturas || permit.selectedWorkTypes?.alturas) && permit.approvals?.coordinador_alturas?.status !== 'aprobado') {
                return {
                    allowed: false,
                    reason: 'Se requiere primero la firma del Coordinador de Trabajos en Alturas.'
                };
            }
            break;
        case 'autorizante':
            if (currentUser.role !== 'autorizante' && currentUser.role !== 'admin') {
                return {
                    allowed: false,
                    reason: 'Rol de autorizante requerido para esta firma.'
                };
            }
            if (permit.approvals?.solicitante?.status !== 'aprobado') {
                return {
                    allowed: false,
                    reason: 'Se requiere primero la firma del solicitante.'
                };
            }
            break;
        case 'lider_sst':
            if (currentUser.role !== 'lider_sst' && currentUser.role !== 'admin') {
                return {
                    allowed: false,
                    reason: 'Rol de Líder SST requerido para esta firma.'
                };
            }
            ...
            if (!permit.isSSTSignatureRequired) {
                return {
                    allowed: false,
                    reason: 'Firma de SST no es requerida para este permiso.'
                };
            }
            if (permit.approvals?.solicitante?.status !== 'aprobado') {
                return {
        ...
        case 'mantenimiento':
            if (currentUser.role !== 'mantenimiento' && currentUser.role !== 'admin') {
                return {
                    allowed: false,
                    reason: 'Rol de Mantenimiento requerido para esta firma.'
                };
            }
            if (!permit.controlEnergia) {
                return {
                    allowed: false,
                    reason: 'Firma de Mantenimiento solo aplica cuando hay control de energías.'
                };
            }
            if (permit.approvals?.autorizante?.status !== 'aprobado') {
                return {
                    allowed: false,
                    reason: 'Se requiere primero la firma del autorizante.'
                };
            }
            break;
    }
...
async function addDailyValidationSignature(permitId, anexoName, validationType, index, data, user) {
    ...
    try {
        ...
        if (![
            ...
            return {
                success: false,
                error: 'Solo se pueden agregar validaciones diarias en permisos EN EJECUCIÓN o SUSPENDIDOS.'
            };
        }
...
Puede ver los detalles aquí:
${permitUrl}`;
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notifications$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sendWhatsAppNotification"])(whatsappMessage);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidatePath"])(`/permits/${permitId}`);
        return {
            success: true
        };
...
async function addWorkerSignature(permitId, workerIndex, signatureType, signatureDataUrl) {
    ...
    try {
        ...
        if (signatureType === 'firmaCierre' && ![
            ...
            return {
                success: false,
                error: 'Solo se puede firmar cierre en permisos EN EJECUCIÓN o SUSPENDIDOS.'
            };
        }
...
"[project]/.next-internal/server/app/(app)/permits/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/(app)/permits/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/(app)/permits/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/(app)/permits/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";

return __turbopack_context__.a(async (__turbopack_handle_async_dependencies__, __turbopack_async_result__) => { try {

__turbopack_context__.s([
    "7873b9c7850e737568a6f6f7a4e17cda15a8f18e15",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["updatePermitStatus"],
    "78ef86f0b5ad2d150f478f7151b2ac622c1a91d8a4",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addWorkerSignature"],
    "7e15bdb6ac388e78a59299d5091891127d63de7bc6",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addSignatureAndNotify"],
    "7edc6233c637b331b2fa6dba912da67e147424b389",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["addDailyValidationSignature"]
]);
...
[__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f28$app$292f$permits$2f5b$id$5d2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
...
"[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (client reference proxy) <module evaluation>", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/app/(app)/permits/[id]/page.tsx <module evaluation> from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/(app)/permits/[id]/page.tsx <module evaluation>", "default");
}),
"[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (client reference proxy)", ((__turbopack_context__) => {
"use strict";
...
;
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$rsc$2f$react$2d$server$2d$dom$2d$turbopack$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerClientReference"])(function() {
    throw new Error("Attempted to call the default export of [project]/src/app/(app)/permits/[id]/page.tsx from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
}, "[project]/src/app/(app)/permits/[id]/page.tsx", "default");
}),
"[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f5b$id$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (client reference proxy) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f5b$id$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__ = __turbopack_context__.i("[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (client reference proxy)");
;
__turbopack_context__.n(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$app$292f$permits$2f5b$id$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$client__reference__proxy$29$__);
}),
"[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (ecmascript, Next.js Server Component)", ((__turbopack_context__) => {

__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/(app)/permits/[id]/page.tsx [app-rsc] (ecmascript)"));
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__503b0cdb._.js.map