...
const COLUMNAS: {
  ...
  { key: 'seguimientos',              label: 'Seguimientos',                    requerido: false, ejemplo: '05/06/2026 | 50 | Se instaló línea de vida; 20/06/2026 | 100 | Verificado en sitio', nota: 'Varios en una celda: fecha | % | observación, separados por ";"' },
  { key: 'fechaSeguimiento1',         label: 'Fecha de Seguimiento',            requerido: false, ejemplo: '05/06/2026',  nota: 'Solo si NO usa la columna Seguimientos — dd/mm/aaaa' },
...
function buildInstruccionesSheet(): XLSX.WorkSheet {
  ...
  const rows: [string, string][] = [
    ...
    ['Seguimientos',                 'Permite registrar VARIOS seguimientos en una sola celda.\nFormato de cada uno: fecha | % | observación   (el % y la observación son opcionales)\nSepare cada seguimiento con punto y coma ";".\nEj: 05/06/2026 | 50 | Se instaló línea de vida; 20/06/2026 | 100 | Verificado en sitio'],
    ['Fecha de Seguimiento',         'Compatibilidad con plantillas anteriores: un único seguimiento. Se ignora si la columna "Seguimientos" trae datos. Formato: dd/mm/aaaa'],
    ['% de Cumplimiento',            'Número entre 0 y 100. Acompaña a "Fecha de Seguimiento" cuando no se usa la columna "Seguimientos".'],
