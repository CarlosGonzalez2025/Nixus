                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="flex flex-wrap items-center justify-end gap-2 flex-1">
                       ...
                       <Button onClick={() => handlePDFExport('all')}>
                           <FileDown className="mr-2"/> Exportar PDFs
                       </Button>
                       
                       {canQuickClose && (
                          <Button variant="destructive" onClick={handleEmergencyClosure}>
                              <Lock className="mr-2"/>Cerrar Permiso Ahora
                          </Button>
                       )}
              ...
              <AlertDialog open={showEmergencyClosureDialog} onOpenChange={setShowEmergencyClosureDialog}>
                  <AlertDialogContent>
                      <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                              <p className="mb-3">Se han detectado las siguientes tareas pendientes:</p>
                              ...
                              <p className="mt-3">¿Aún así desea forzar el cierre del permiso?</p>
                          </AlertDialogDescription>
                      </AlertDialogHeader>
                      <div className="space-y-2">
