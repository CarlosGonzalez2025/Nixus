...
- **`NEXT_PUBLIC_BASE_URL`** es `https://studio--studio-7636781267-6dc02.us-central1.hosted.app`, que **es correcta**: es la URL del backend de App Hosting. El dominio `sistedigital.net` que aparece en el `.env` local se usa como **remitente de correo** (`FROM_EMAIL`), no como host de la aplicación. Es el valor que deben usar también los jobs de Cloud Scheduler.
